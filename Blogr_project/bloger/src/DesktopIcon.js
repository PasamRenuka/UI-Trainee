const DesktopIcon=(width,height)=>{
    return <svg width="925" height="882" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <defs>
    ...
    <g transform="translate(40)" fill="none" fillRule="evenodd">
       ...
       <path d="M209 284c47.125-73.367 81.977-113.013 104.557-118.938 33.87-8.886 23.765 83.14 72.535 72.473 48.77-10.666 54.716-103.974 91.603-108.37 36.887-4.397 56.402 80.946 72.515 88.81 10.742 5.241 24.005-6.094 39.79-34.007" stroke="url(#e)" strokeWidth="8" strokeLinecap="round" transform="translate(0 242)"/>
    </g>
 </svg>
}
