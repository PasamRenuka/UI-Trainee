import {
  ...
  import MainProBtn from './main_app_pro_btn'
  
  function Bloger(toggleElements) {
    return (
      <Sample>
        <Nav toggleElements={toggleElements}>
          <Navtop>
            <div>
            ...
            <LoginDiv>
              <LoginSignup>
                <B><RouteLink to="/login">Login</RouteLink></B>
              </LoginSignup>
              <LoginSignup>
                <B><RouteLink to="/" >Sign Up</RouteLink></B>
              </LoginSignup>
               <LoginSignup>
                <B> <RouteLink id='User-Router' to="/Profile" >Profile</RouteLink></B>
              </LoginSignup>
              {/* <LoginSignup>
